mdes.cra4r2 <- function(power=.80, alpha=.05, two.tail=TRUE,
...
# example
# mdes.cra4r2(rho4=.05, rho3=.15, rho2=.15, omega4=.50, omega3=.50, n=10, J=4, K=4, L=20)

power.cra4r2 <- function(mdes=.25, alpha=.05, two.tail=TRUE,
                         rho2, rho3, rho4, omega3, omega4,
                         P=.50, R12=0, R22=0, RT32=0, RT42=0, g4=0,
                         n, J, K, L, ...){
  df = L-g4-1
...
# example
# power.cra4r2(rho4=.05, rho3=.15, rho2=.15, omega4=.50, omega3=.50, n=10, J=4, K=4, L=20)


# gm = grid multiplier: default 2
# ncase = numer of fixed samples in the output
# constrain = "power", or "mdes" :  default "power"
mrss.cra4r2 <- function(mdes=.25, power=.80, alpha=.05, two.tail=TRUE,
...
# example
# mrss.cra4r2(rho4=.05, rho3=.15, rho2=.15, omega4=.50, omega3=.50, n=10, J=2, K=10)
# mrss.cra4r2(rho4=.05, rho3=.15, rho2=.15, omega4=.50, omega3=.50, n=10, J=2, L=12)
# mrss.cra4r2(rho4=.05, rho3=.15, rho2=.15, omega4=.50, omega3=.50, n=10, K=10, L=12)
# mrss.cra4r2(rho4=.05, rho3=.15, rho2=.15, omega4=.50, omega3=.50, J=2, K=10, L=12)
...
optimal.cra4r2 <- function(cn, cJ, cK, cL, cost=NULL, n=NULL, J=NULL, K=NULL, L=NULL,
...
# optimal.cra4r2(cn=1, cJ=10, cK=100, cL=1000, cost=75600, constrain="cost",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50, omega3=.50)

# optimal sample given per unit costs and power 
# optimal.cra4r2(cn=1, cJ=10, cK=100, cL=1000, power=.80, constrain="power",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50, omega3=.50)

# optimal sample given per unit costs and mdes
# optimal.cra4r2(cn=1, cJ=10, cK=100, cL=1000, power=.80, constrain="mdes", mdes=.50,
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50, omega3=.30)

# conditional optimal sample (fixed n=10, and J=2) given total cost
# optimal.cra4r2(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, cost=75600, constrain="cost",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50, omega3=.50)

# conditional optimal sample (fixed n=10, and J=2) given per unit costs and power 
# optimal.cra4r2(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, power=.80, constrain="power",
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50, omega3=.50)

# conditional optimal sample (fixed n=10, and J=2) given per unit costs and mdes
# optimal.cra4r2(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, power=.80, constrain="mdes", 
#                rho4=.10, rho3=.15, rho2=.20, omega4=.50, omega3=.50)
