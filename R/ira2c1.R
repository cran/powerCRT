mdes.ira2c1 <- function(power=.80, alpha=.05, two.tail=TRUE,
                        P=.50, g1=0, R12=0, n, J, ...){
  df = J*(n-1)-g1-1
...
# example
# mdes.ira2c1(n=55, J=14)

power.ira2c1 <- function(mdes=.25, alpha=.05, two.tail=TRUE,
                        P=.50, g1=0, R12=0, n, J, ...){
  df = J*(n-1)-g1-1
...
optimal.ira2c1 <- function(cn, cJ, cost=NULL, n=NULL, J=NULL,
...
# optimal.ira2c1(cn=1, cJ=10, cost=560, constrain="cost")

# optimal sample given per unit costs and power 
# optimal.ira2c1(cn=1, cJ=10, constrain="power", gm=300)

# optimal sample given per unit costs and mdes
# optimal.ira2c1(cn=1, cJ=10, constrain="mdes", gm=300)

# conditional optimal sample (fixed n=10) given total cost
# optimal.ira2c1(cn=1, cJ=10, n=10, cost=560, constrain="cost")

# conditional optimal sample (fixed n=10) given per unit costs and power 
# optimal.ira2c1(cn=1, cJ=10, n=10, constrain="power")

# conditional optimal sample (fixed n=10) given per unit costs and mdes
# optimal.ira2c1(cn=1, cJ=10, n=10, constrain="mdes")
