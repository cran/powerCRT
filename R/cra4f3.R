mdes.cra4f3 <- function(power=.80, alpha=.05, two.tail=TRUE,
...
# example
# mdes.cra4f3(alpha=.05, two.tail=TRUE, power=.80, rho3=.15, rho2=.15, n=10, J=4, K=4, L=15)

power.cra4f3 <- function(mdes=.25, alpha=.05, two.tail=TRUE,
                         rho2, rho3, P=.50, R12=0, R22=0, R32=0, g3=0,
                         n, J, K, L, ...){
  df = L*(K-2)-g3
...
# example
# power.cra4f3(mdes=0.24, alpha=.05, two.tail=TRUE, rho3=.15, rho2=.15, n=10, J=4, K=4, L=15)
...
mrss.cra4f3 <- function(mdes=.25, power=.80, alpha=.05, two.tail=TRUE,
...
# example
# mrss.cra4f3(rho3=.15, rho2=.15, g3=1, P=.5, R32=.5, R22=.5, R12=.5, n=10, J=4, K=4)
# mrss.cra4f3(rho3=.15, rho2=.15, g3=1, P=.5, R32=.5, R22=.5, R12=.5, n=10, J=4, L=14)
# mrss.cra4f3(rho3=.15, rho2=.15, g3=1, P=.5, R32=.5, R22=.5, R12=.5, n=10, K=4, L=14)
# mrss.cra4f3(rho3=.15, rho2=.15, g3=1, P=.5, R32=.5, R22=.5, R12=.5, J=4, K=4, L=14)
...
optimal.cra4f3 <- function(cn, cJ, cK, cL, cost=NULL, n=NULL, J=NULL, K=NULL, L=NULL,
...
# optimal.cra4f3(cn=1, cJ=10, cK=100, cL=1000, cost=75600, constrain="cost", rho3=.15, rho2=.20)

# optimal sample given per unit costs and power 
# optimal.cra4f3(cn=1, cJ=10, cK=100, cL=1000, power=.80, constrain="power", rho3=.15, rho2=.20, nJKL0=c(3,3,3,3))

# optimal sample given per unit costs and mdes
# optimal.cra4f3(cn=1, cJ=10, cK=100, cL=1000, power=.80, constrain="mdes", rho3=.15, rho2=.20, nJKL0=c(3,3,3,3))

# conditional optimal sample (fixed n=10, and J=2) given total cost
# optimal.cra4f3(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, cost=75600, constrain="cost", rho3=.15, rho2=.20)

# conditional optimal sample (fixed n=10, and J=2) given per unit costs and power 
# optimal.cra4f3(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, power=.80, constrain="power", rho3=.15, rho2=.20, nJKL0=c(3,3,3,3))

# conditional optimal sample (fixed n=10, and J=2) given per unit costs and mdes
# optimal.cra4f3(cn=1, cJ=10, cK=100, cL=1000, n=10, J=2, power=.80, constrain="mdes", rho3=.15, rho2=.20, nJKL0=c(3,3,3,3))
