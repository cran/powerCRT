mdes.ira2r1 <- function(power=.80, alpha=.05, two.tail=TRUE,
...
# example
# mdes.ira2r1(rho2=.35, omega2=.10, n=83, J=480)


power.ira2r1 <- function(mdes=.25, alpha=.05, two.tail=TRUE,
...
# example
# mrss.ira2r1(rho2=.35, omega2=.10, n=83)
# mrss.ira2r1(rho2=.35, omega2=.10, J=10) 
...
optimal.ira2r1 <- function(cn, cJ, cost=NULL, n=NULL, J=NULL,
...
# optimal.ira2r1(cn=1, cJ=10, cost=560, constrain="cost", rho2=.20, omega2=.50)

# optimal sample given per unit costs and power 
# optimal.ira2r1(cn=1, cJ=10, power=.80, constrain="power", rho2=.20, omega2=.50)

# optimal sample given per unit costs and mdes
# optimal.ira2r1(cn=1, cJ=10, power=.80, constrain="mdes", rho2=.20, omega2=.50)

# conditional optimal sample (fixed n=10) given total cost
# optimal.ira2r1(cn=1, cJ=10, n=10, cost=560, constrain="cost", rho2=.20, omega2=.50)

# conditional optimal sample (fixed n=10) given per unit costs and power 
# optimal.ira2r1(cn=1, cJ=10, n=10, constrain="power", rho2=.20, omega2=.50)

# conditional optimal sample (fixed n=10) given per unit costs and mdes
# optimal.ira2r1(cn=1, cJ=10, n=10, constrain="mdes", rho2=.20, omega2=.50)
