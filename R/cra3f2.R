mdes.cra3f2 <- function(power=.80, alpha=.05, two.tail=TRUE,
...
# example
# mdes.cra3f2(rho2=.10, n=20, J=44, K=5)


power.cra3f2 <- function(mdes=.25, alpha=.05, two.tail=TRUE,
                         rho2, P=.50, g2=0, R12=0, R22=0,
                         n, J, K, ...){
  df = K*(J-2)-g2
...
# example
# mrss.cra3f2(rho2=.10, n=10, J=3)
# mrss.cra3f2(rho2=.10, n=10, K=34)
# mrss.cra3f2(rho2=.10, J=3, K=34)
...
optimal.cra3f2 <- function(cn, cJ, cK, cost=NULL, n=NULL, J=NULL, K=NULL,
...
# optimal.cra3f2(cn=1, cJ=10, cK=100, cost=5600, constrain="cost", rho2=.20)

# optimal sample given per unit costs and power 
# optimal.cra3f2(cn=1, cJ=10, cK=100, power=.80, constrain="power", rho2=.20)

# optimal sample given per unit costs and mdes
# optimal.cra3f2(cn=1, cJ=10, cK=100, power=.80, constrain="mdes",  rho2=.20)

# conditional optimal sample (fixed n=10) given total cost
# optimal.cra3f2(cn=1, cJ=10, cK=100, n=10, cost=5600, constrain="cost",  rho2=.20)

# conditional optimal sample (fixed J=10) given per unit costs and power 
# optimal.cra3f2(cn=1, cJ=10, cK=100, J=10, constrain="power", rho2=.20)

# conditional optimal sample (fixed n=10) given per unit costs and mdes
# optimal.cra3f2(cn=1, cJ=10, cK=100, K=3, constrain="mdes", rho2=.20)
